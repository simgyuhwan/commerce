...
import com.livecommerce.common.support.error.ErrorMessage
import com.livecommerce.common.support.error.ErrorType
...
data class ApiResponse<T>(
    ...
    companion object {
        fun success(): ApiResponse<Void> = ApiResponse(ResultType.SUCCESS, null, null)
